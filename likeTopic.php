...
<?php 
	...
	if(isset($_POST['like_topic'])) {
		...
		if ($validate->userNotLikeTopic($_POST['topic_id'])) {
			...
			redirect('./', 'You already liked it!', 'error');
		}
