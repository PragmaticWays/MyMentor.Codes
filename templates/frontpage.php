					...
					<div class="col-md-10">
						<div class="topic-content">
							...
							<div class="topic-info">
								<a href="<?php echo BASE_URI; ?>topics/category/<?php echo urlFormat($topic->name); ?>"><?php echo $topic->name; ?></a> >> 
								<a href="<?php echo BASE_URI; ?>topics/user/<?php echo urlFormat($topic->username); ?>"><?php echo $topic->username; ?></a> >>
